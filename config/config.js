...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\chips\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/chips/';
  if (isLinux) dataDir = process.env.HOME + '/.chips/';
}
